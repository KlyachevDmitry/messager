...
class RSA:
    def __init__(self):
        open_key, closed_key = self.generate_keys()
        massages = [1, 2, 3, 1, 5, 7]
        crypt_massage = self.crypt_massages(massages, open_key)
        #print(crypt_massage)
        decrypt_massage = self.decrypt_massages(crypt_massage, closed_key)
